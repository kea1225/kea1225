...
DATABASES = {
    'default': {
        ...
        'NAME': capstone-database'', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'capstone-database-id.cthmxcwkr4jf.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = capstone-s3-bucket1-karil'' # please enter your s3 bucket name
